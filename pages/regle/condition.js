...
export default function golduck() {
  return (
    <div style={{width: '100%'}}>
      <h1>Terms and Conditions</h1>
      <p className={Styles.p}>Last updated: January 13, 2023</p>
      ...
      <h2>Definitions</h2>
      <p className={Styles.p}>For the purposes of these Terms and Conditions:</p>
      <ul>
        <li>
          <p className={Styles.p}>
        ...
        <li>
          <p className={Styles.p}>
            ...
            this Agreement) refers to topdoc, 0 rue docteur 00000.
          </p>
        </li>
        <li>
          <p className={Styles.p}>
        ...
        <li>
          <p className={Styles.p}>
            <strong>Website</strong> refers to Topdoc, accessible from{" "}
            <a
      ...
      <ul>
        <li>By email: topdoc@gmail.com</li>
      </ul>
    </div>
  );
}
